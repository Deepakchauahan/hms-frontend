...
export default function Footer() {
  return (
    <footer className={`footer border-b-2  border-blue  pt-20  bg-blue `}>
      <div className="container">
        <div className="grid  grid-cols-6 gap-20 pb-14 text-white">
          <div className="col-span-2">
            <Image src={Logo} className="brightness-0 invert" />
            <p className="my-4 text-white text-[14px]">
              Lorem Ipsum has been the industry's standard dummy text ever since
              the 1500s, when an unknown printer took a galley of type and
              scrambled it
            </p>
            <p className="my-4 text-white text-[14px] font-bold">
        ...
        <div className="py-3 border-t border-orange flex items-center justify-between">
          ...
          <ul className="list-none flex gap-4 items-center">
            <p className="text-white text-[14px] font-bold  ">Find us on:</p>
            <li>
              <Link href="#!" target="_blank">
                <PiInstagramLogoBold size={25} color="white" />
              </Link>
            </li>
            <li>
              <Link href="#!" target="_blank">
                <PiFacebookLogoBold size={25} color="white" />
              </Link>
            </li>
            <li>
              <Link href="#!" target="_blank">
                <PiYoutubeLogoBold size={25} color="white" />
              </Link>
            </li>
            <li>
              <Link href="#!" target="_blank">
                <PiXLogoBold size={25} color="white" />
              </Link>
            </li>
          </ul>
        </div>
