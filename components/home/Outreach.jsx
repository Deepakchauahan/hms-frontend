            ...
            <div className="container">
                ...
                <div className='grid grid-cols-3  gap-6'>
                    <div className='border p-4 rounded-lg border-sectionBg hover:shadow-xl'>
                        <Image src={Outreach1} className="rounded-lg" />
                    ...
                    <div className='border p-4 rounded-lg border-sectionBg hover:shadow-xl'>
                        <Image src={Outreach2} className="rounded-lg" />
                    ...
                    <div className='border p-4 rounded-lg border-sectionBg hover:shadow-xl'>
                        <Image src={Outreach3} className="rounded-lg" />
                    ...
                    <div className='border p-4 rounded-lg border-sectionBg hover:shadow-xl'>
                        <Image src={Outreach4} className="rounded-lg" />
                    ...
                    <div className='border p-4 rounded-lg border-sectionBg hover:shadow-xl'>
                        <Image src={Outreach5} className="rounded-lg" />
                    ...
                    <div className='border p-4 rounded-lg border-sectionBg hover:shadow-xl'>
                        <Image src={Outreach6} className="rounded-lg" />
