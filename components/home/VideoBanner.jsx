...
export default function VideoBanner() {
  return (
    <>
      <section className="home-banner relative  h-[660px]">
        <video
          autoPlay
          muted
          playsInline
          loop
          className="w-screen h-[660px] object-cover"
        ...
        <div className="home-banner-content absolute top-0 left-0  right-0 bottom-0 py-[100px] m-auto h-full flex items-center z-50">
          <div className="container">
            <div className="max-w-[35%] px-0 py-5 rounded-ss-2xl rounded-ee-2xl">
              <h4 className=" font-bold text-white uppercase max-w-max text-under-style">
                We provide total
              </h4>
              <h2 className="text-[40px] font-bold text-white mb-4">
                Dental Care <span className="text-orange">Solution</span>
              </h2>
              <p className="font-normal text-white tracking-wide">
